...
class DeepQLearning(LightningModule):
    ...
    def __init__(self, max_steps, save_location, policy=epsilon_greedy, capacity=100_000,
                 ...
                 b_start=0.4, b_end=0, b_last_episode=100):
        super().__init__()
        self.env = env
    ...
    def training_step(self, batch, batch_idx):
        ...
        td_errors = (state_action_values - expected_state_action_values).abs().detach().numpy()
    ...
    def save_reward_plots(self, step_rewards, episode_rewards, location):
        ...
        plt.figure()
        plt.title("Episode Rewards PrioritizedExpRepDQN")
        ...
        plt.figure()
        plt.title("Step Rewards PrioritizedExpRepDQN")
...
algorithm = DeepQLearning(1000, save_location='./PrioritizedExpRep_results/')
